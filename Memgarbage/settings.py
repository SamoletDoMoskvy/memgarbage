"""
Django settings for Memgarbage project.
...
SECRET_KEY = 'django-insecure-(yf)n_z6-$%26v(=+^tpvj=_k1jkomooapglkk7=jzoc1j-8i$'
...
WSGI_APPLICATION = 'Memgarbage.wsgi.application'
